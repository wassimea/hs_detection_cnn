...
def get_iou_totals_per_image(gt_objects, positive_props,detections_regressed,file):
    total_props_iou = 0
    ...
    return average_props_iou, average_detections_iou, total_gt, total_positives, total_negatives,average_pckh_precision
