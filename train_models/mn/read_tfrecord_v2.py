...
def read_single_tfrecord_3c(tfrecord_file, batch_size):
    ...
    image, label,filename = tf.train.batch(
...
def read_multi_tfrecords(tfrecord_files, batch_sizes):
    ...
    if(config.input_channels == 4):
        ...
        pos_image,pos_label, pos_filename = read_single_tfrecord_3c(pos_dir, pos_batch_size)   #read pos_batch_size number of positive samples with their labels,rois, and landmarks
        neg_image,neg_label,neg_filename = read_single_tfrecord_3c(neg_dir, neg_batch_size)   #read neg_batch_size number of positive samples with their labels,rois, and landmarks
    ...
    return images,labels,filenames #return a batch with size batch_size of images, labels, rois, and landmarks from different samples of pos,neg and landmarks
