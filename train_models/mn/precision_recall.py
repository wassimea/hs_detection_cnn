...
def evaluate():
    ...
    models.append('/Data2TB/chl_data/CKPTS/aggregated/mse/0.4/CNN5/3_onet_cnn5mse/')
    models.append('/Data2TB/chl_data/CKPTS/aggregated/mse/0.6/CNN5/3_onet_cnn5mse/')
    models.append('/Data2TB/chl_data/CKPTS/aggregated/mse/0.8/CNN5/3_onet_cnn5mse/')
    ...
    for model in models:
        if "0.4" in model:
            folder = "/Data2TB/correctly_registered/S12/test/aggregated/0.4/"
        elif "0.6" in model:
            folder = "/Data2TB/correctly_registered/S12/test/aggregated/0.6/"
        elif "0.8" in model:
            folder = "/Data2TB/correctly_registered/S12/test/aggregated/0.8/"
        else:
